# [甲辰一师一课](https://gitee.com/horse_jlg/sd1s1k-jachin-client-demo.git)
...
|名称|位置|类型|必选|说明|
|---|---|---|---|---|
|actId|path|string| 是 |本次优课活动编号，今年的默认为sd2024|
|catalogId|query|integer| 是 |活动目录编号|
...
|»» activityId|string|false|none|活动Id|今年默认使用sd2024|
...
|» catalogId|body|string| 否 |活动目录编号|
|» activityId|body|string| 否 |活动编号(今年默认使用sd2024)|
